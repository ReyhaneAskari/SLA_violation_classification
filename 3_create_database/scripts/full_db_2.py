...
data2 = pd.concat([data,violated_series],axis=1)
data2.rename(columns={0:'violation'}, inplace=True)
data2.to_csv('/home/askrey/Dropbox/Project_step_by_step/3_create_database/csvs/frull_db_2.csv')
